...
.floater-icon {
            ...
            z-index: 1000; /* Ensure the icon is in front */
        }
        .wrapper {
            ...
            z-index: 999; /* Ensure the chatbox is in front of most elements */
        }
        .title {
            background-color: #007bff;
            color: white;
				...
				<ul>
					...
					if(isset($_SESSION['cart_p_id'])) {
	                    ...
	                    for($i=1;$i<=count($arr_cart_p_qty);$i++) {
	                    	$row_total_price = (int)substr($arr_cart_p_current_price[$i],0,-3)*$arr_cart_p_qty[$i];
